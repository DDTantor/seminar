...
void driver (const GV& gv, double dt, double a, double b, double K,
             double D1, double D2, double T_end, std::string name)
{
    double time = 0.0;
    ...
    using LOP = LocalOperator<U_BCTypeParam, BCTypeParam<GV>,FEM>;
    LOP lop(bctype,bctype0,a,b,D1,D2,K);
